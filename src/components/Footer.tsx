...
const Footer = ({ showContactForm }: FooterProps) => {
  return (
    <footer id="contact" className="bg-brand-dark text-white py-20">
      <div className="container mx-auto px-6">
        {/* Section formulaire de contact - conditionnelle */}
        {showContactForm && (
          <div className="mb-20">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-brand-purple rounded-full flex items-center justify-center hover:bg-brand-purple/80 transition-colors">
