            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              {Array.from({ length: 9 }, (_, index) => {
                const images = [
                  ...
                  '/lovable-uploads/23cdd733-e7b7-4a07-b2d5-e0a9dce5b609.png', // bottes cowboy
                    ...
                    {index === 4 ? (
                      <div className="w-full h-full rounded-lg flex items-center justify-center p-2" style={{backgroundColor: '#B6B0DD'}}>
                        <img 
                          ...
                          alt="Sync" 
                          className="w-full h-full object-contain animate-pulse hover:animate-spin transition-all duration-300"
                        />
                      </div>
                    ) : (
