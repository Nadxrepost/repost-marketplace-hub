      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">Repost est l'infrastructure qui permet aux marques et Opérateurs de revente de transformer leur stock en canal de vente sur les marketplaces.</p>
